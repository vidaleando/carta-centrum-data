...
-- Run this SQL in your PostgreSQL database to create the necessary schema
...
INSERT INTO geo_data (name, description, category, geom) VALUES
...
-- GRANT SELECT ON geo_data TO your_app_user;
-- GRANT INSERT, UPDATE, DELETE ON geo_data TO your_app_user;
-- GRANT USAGE, SELECT ON SEQUENCE geo_data_id_seq TO your_app_user;
